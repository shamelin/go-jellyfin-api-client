...
// checks if the JellyfinActivityLogEntryQueryResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinActivityLogEntryQueryResult{}

// JellyfinActivityLogEntryQueryResult Query result container.
type JellyfinActivityLogEntryQueryResult struct {
	// Gets or sets the items.
	Items []JellyfinActivityLogEntry `json:"Items,omitempty"`
...
func NewJellyfinActivityLogEntryQueryResult() *JellyfinActivityLogEntryQueryResult {
	this := JellyfinActivityLogEntryQueryResult{}
	return &this
}
...
func (o *JellyfinActivityLogEntryQueryResult) GetItems() []JellyfinActivityLogEntry {
...
func (o *JellyfinActivityLogEntryQueryResult) GetItemsOk() ([]JellyfinActivityLogEntry, bool) {
	if o == nil || IsNil(o.Items) {
		return nil, false
	}
	return o.Items, true
...
// SetItems gets a reference to the given []JellyfinActivityLogEntry and assigns it to the Items field.
func (o *JellyfinActivityLogEntryQueryResult) SetItems(v []JellyfinActivityLogEntry) {
	o.Items = v
}
...
func (o JellyfinActivityLogEntryQueryResult) MarshalJSON() ([]byte, error) {
...
func (o JellyfinActivityLogEntryQueryResult) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinActivityLogEntryQueryResult struct {
	value *JellyfinActivityLogEntryQueryResult
	isSet bool
}

func (v NullableJellyfinActivityLogEntryQueryResult) Get() *JellyfinActivityLogEntryQueryResult {
	return v.value
}

func (v *NullableJellyfinActivityLogEntryQueryResult) Set(val *JellyfinActivityLogEntryQueryResult) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinActivityLogEntryQueryResult) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinActivityLogEntryQueryResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinActivityLogEntryQueryResult(val *JellyfinActivityLogEntryQueryResult) *NullableJellyfinActivityLogEntryQueryResult {
	return &NullableJellyfinActivityLogEntryQueryResult{value: val, isSet: true}
}

func (v NullableJellyfinActivityLogEntryQueryResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinActivityLogEntryQueryResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
