...
// checks if the JellyfinMovieInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinMovieInfo{}

// JellyfinMovieInfo struct for JellyfinMovieInfo
type JellyfinMovieInfo struct {
...
func (o *JellyfinMovieInfo) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *JellyfinMovieInfo) SetOriginalTitleNil() {
...
func (o *JellyfinMovieInfo) SetPathNil() {
	o.Path.Set(nil)
}
...
func (o *JellyfinMovieInfo) SetMetadataLanguageNil() {
...
func (o *JellyfinMovieInfo) SetMetadataCountryCodeNil() {
...
func (o *JellyfinMovieInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *JellyfinMovieInfo) SetIndexNumberNil() {
...
func (o *JellyfinMovieInfo) SetParentIndexNumberNil() {
...
func (o *JellyfinMovieInfo) SetPremiereDateNil() {
...
func (o JellyfinMovieInfo) MarshalJSON() ([]byte, error) {
...
func (o JellyfinMovieInfo) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinMovieInfo struct {
	value *JellyfinMovieInfo
	isSet bool
}

func (v NullableJellyfinMovieInfo) Get() *JellyfinMovieInfo {
	return v.value
}

func (v *NullableJellyfinMovieInfo) Set(val *JellyfinMovieInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinMovieInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinMovieInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinMovieInfo(val *JellyfinMovieInfo) *NullableJellyfinMovieInfo {
	return &NullableJellyfinMovieInfo{value: val, isSet: true}
}

func (v NullableJellyfinMovieInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinMovieInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
