...
// checks if the JellyfinBoxSetInfoRemoteSearchQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinBoxSetInfoRemoteSearchQuery{}

// JellyfinBoxSetInfoRemoteSearchQuery struct for JellyfinBoxSetInfoRemoteSearchQuery
type JellyfinBoxSetInfoRemoteSearchQuery struct {
	SearchInfo NullableJellyfinBoxSetInfo `json:"SearchInfo,omitempty"`
...
func NewJellyfinBoxSetInfoRemoteSearchQuery() *JellyfinBoxSetInfoRemoteSearchQuery {
	this := JellyfinBoxSetInfoRemoteSearchQuery{}
	return &this
}
...
func (o *JellyfinBoxSetInfoRemoteSearchQuery) GetSearchInfo() JellyfinBoxSetInfo {
	if o == nil || IsNil(o.SearchInfo.Get()) {
		var ret JellyfinBoxSetInfo
		return ret
	}
...
func (o *JellyfinBoxSetInfoRemoteSearchQuery) GetSearchInfoOk() (*JellyfinBoxSetInfo, bool) {
	if o == nil {
		return nil, false
	}
...
// SetSearchInfo gets a reference to the given NullableJellyfinBoxSetInfo and assigns it to the SearchInfo field.
func (o *JellyfinBoxSetInfoRemoteSearchQuery) SetSearchInfo(v JellyfinBoxSetInfo) {
	o.SearchInfo.Set(&v)
}
// SetSearchInfoNil sets the value for SearchInfo to be an explicit nil
func (o *JellyfinBoxSetInfoRemoteSearchQuery) SetSearchInfoNil() {
...
func (o *JellyfinBoxSetInfoRemoteSearchQuery) SetSearchProviderNameNil() {
...
func (o JellyfinBoxSetInfoRemoteSearchQuery) MarshalJSON() ([]byte, error) {
...
func (o JellyfinBoxSetInfoRemoteSearchQuery) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinBoxSetInfoRemoteSearchQuery struct {
	value *JellyfinBoxSetInfoRemoteSearchQuery
	isSet bool
}

func (v NullableJellyfinBoxSetInfoRemoteSearchQuery) Get() *JellyfinBoxSetInfoRemoteSearchQuery {
	return v.value
}

func (v *NullableJellyfinBoxSetInfoRemoteSearchQuery) Set(val *JellyfinBoxSetInfoRemoteSearchQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinBoxSetInfoRemoteSearchQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinBoxSetInfoRemoteSearchQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinBoxSetInfoRemoteSearchQuery(val *JellyfinBoxSetInfoRemoteSearchQuery) *NullableJellyfinBoxSetInfoRemoteSearchQuery {
	return &NullableJellyfinBoxSetInfoRemoteSearchQuery{value: val, isSet: true}
}

func (v NullableJellyfinBoxSetInfoRemoteSearchQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinBoxSetInfoRemoteSearchQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
