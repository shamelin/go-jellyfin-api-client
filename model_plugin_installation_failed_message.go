...
// checks if the PluginInstallationFailedMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginInstallationFailedMessage{}
...
func NewPluginInstallationFailedMessage() *PluginInstallationFailedMessage {
	this := PluginInstallationFailedMessage{}
	return &this
}
...
type NullablePluginInstallationFailedMessage struct {
	value *PluginInstallationFailedMessage
	isSet bool
}

func (v NullablePluginInstallationFailedMessage) Get() *PluginInstallationFailedMessage {
	return v.value
}

func (v *NullablePluginInstallationFailedMessage) Set(val *PluginInstallationFailedMessage) {
	v.value = val
	v.isSet = true
}

func (v NullablePluginInstallationFailedMessage) IsSet() bool {
	return v.isSet
}

func (v *NullablePluginInstallationFailedMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePluginInstallationFailedMessage(val *PluginInstallationFailedMessage) *NullablePluginInstallationFailedMessage {
	return &NullablePluginInstallationFailedMessage{value: val, isSet: true}
}
