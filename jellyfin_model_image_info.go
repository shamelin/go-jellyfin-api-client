...
// checks if the JellyfinImageInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinImageInfo{}

// JellyfinImageInfo Class ImageInfo.
type JellyfinImageInfo struct {
	// Gets or sets the type of the image.
	ImageType *JellyfinImageType `json:"ImageType,omitempty"`
...
func (o *JellyfinImageInfo) GetImageType() JellyfinImageType {
...
func (o *JellyfinImageInfo) GetImageTypeOk() (*JellyfinImageType, bool) {
	if o == nil || IsNil(o.ImageType) {
		return nil, false
	}
...
// SetImageType gets a reference to the given JellyfinImageType and assigns it to the ImageType field.
func (o *JellyfinImageInfo) SetImageType(v JellyfinImageType) {
	o.ImageType = &v
}
...
func (o *JellyfinImageInfo) SetImageIndexNil() {
...
func (o *JellyfinImageInfo) SetImageTagNil() {
	o.ImageTag.Set(nil)
}
...
func (o *JellyfinImageInfo) SetPathNil() {
	o.Path.Set(nil)
}
...
func (o *JellyfinImageInfo) SetBlurHashNil() {
	o.BlurHash.Set(nil)
}
...
func (o *JellyfinImageInfo) SetHeightNil() {
	o.Height.Set(nil)
}
...
func (o *JellyfinImageInfo) SetWidthNil() {
	o.Width.Set(nil)
}
...
func (o JellyfinImageInfo) MarshalJSON() ([]byte, error) {
...
func (o JellyfinImageInfo) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinImageInfo struct {
	value *JellyfinImageInfo
	isSet bool
}

func (v NullableJellyfinImageInfo) Get() *JellyfinImageInfo {
	return v.value
}

func (v *NullableJellyfinImageInfo) Set(val *JellyfinImageInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinImageInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinImageInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinImageInfo(val *JellyfinImageInfo) *NullableJellyfinImageInfo {
	return &NullableJellyfinImageInfo{value: val, isSet: true}
}

func (v NullableJellyfinImageInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinImageInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
