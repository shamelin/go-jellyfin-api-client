...
// checks if the JellyfinArtistInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinArtistInfo{}

// JellyfinArtistInfo struct for JellyfinArtistInfo
type JellyfinArtistInfo struct {
...
func (o *JellyfinArtistInfo) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *JellyfinArtistInfo) SetOriginalTitleNil() {
...
func (o *JellyfinArtistInfo) SetPathNil() {
	o.Path.Set(nil)
}
...
func (o *JellyfinArtistInfo) SetMetadataLanguageNil() {
...
func (o *JellyfinArtistInfo) SetMetadataCountryCodeNil() {
...
func (o *JellyfinArtistInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *JellyfinArtistInfo) SetIndexNumberNil() {
...
func (o *JellyfinArtistInfo) SetParentIndexNumberNil() {
...
func (o *JellyfinArtistInfo) SetPremiereDateNil() {
...
func (o *JellyfinArtistInfo) GetSongInfos() []JellyfinSongInfo {
...
// and a boolean to check if the value has been set.
func (o *JellyfinArtistInfo) GetSongInfosOk() ([]JellyfinSongInfo, bool) {
	if o == nil || IsNil(o.SongInfos) {
		return nil, false
	}
...
func (o *JellyfinArtistInfo) SetSongInfos(v []JellyfinSongInfo) {
	o.SongInfos = v
}

func (o JellyfinArtistInfo) MarshalJSON() ([]byte, error) {
...
func (o JellyfinArtistInfo) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinArtistInfo struct {
	value *JellyfinArtistInfo
	isSet bool
}

func (v NullableJellyfinArtistInfo) Get() *JellyfinArtistInfo {
	return v.value
}

func (v *NullableJellyfinArtistInfo) Set(val *JellyfinArtistInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinArtistInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinArtistInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinArtistInfo(val *JellyfinArtistInfo) *NullableJellyfinArtistInfo {
	return &NullableJellyfinArtistInfo{value: val, isSet: true}
}

func (v NullableJellyfinArtistInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinArtistInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
