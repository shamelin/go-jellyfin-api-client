...
// checks if the JellyfinPersonLookupInfoRemoteSearchQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinPersonLookupInfoRemoteSearchQuery{}

// JellyfinPersonLookupInfoRemoteSearchQuery struct for JellyfinPersonLookupInfoRemoteSearchQuery
type JellyfinPersonLookupInfoRemoteSearchQuery struct {
	SearchInfo NullableJellyfinPersonLookupInfo `json:"SearchInfo,omitempty"`
...
func NewJellyfinPersonLookupInfoRemoteSearchQuery() *JellyfinPersonLookupInfoRemoteSearchQuery {
	this := JellyfinPersonLookupInfoRemoteSearchQuery{}
	return &this
}
...
func (o *JellyfinPersonLookupInfoRemoteSearchQuery) GetSearchInfo() JellyfinPersonLookupInfo {
	if o == nil || IsNil(o.SearchInfo.Get()) {
		var ret JellyfinPersonLookupInfo
		return ret
	}
...
func (o *JellyfinPersonLookupInfoRemoteSearchQuery) GetSearchInfoOk() (*JellyfinPersonLookupInfo, bool) {
	if o == nil {
		return nil, false
	}
...
// SetSearchInfo gets a reference to the given NullableJellyfinPersonLookupInfo and assigns it to the SearchInfo field.
func (o *JellyfinPersonLookupInfoRemoteSearchQuery) SetSearchInfo(v JellyfinPersonLookupInfo) {
	o.SearchInfo.Set(&v)
}
// SetSearchInfoNil sets the value for SearchInfo to be an explicit nil
func (o *JellyfinPersonLookupInfoRemoteSearchQuery) SetSearchInfoNil() {
...
func (o *JellyfinPersonLookupInfoRemoteSearchQuery) SetSearchProviderNameNil() {
...
func (o JellyfinPersonLookupInfoRemoteSearchQuery) MarshalJSON() ([]byte, error) {
...
func (o JellyfinPersonLookupInfoRemoteSearchQuery) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinPersonLookupInfoRemoteSearchQuery struct {
	value *JellyfinPersonLookupInfoRemoteSearchQuery
	isSet bool
}

func (v NullableJellyfinPersonLookupInfoRemoteSearchQuery) Get() *JellyfinPersonLookupInfoRemoteSearchQuery {
	return v.value
}

func (v *NullableJellyfinPersonLookupInfoRemoteSearchQuery) Set(val *JellyfinPersonLookupInfoRemoteSearchQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinPersonLookupInfoRemoteSearchQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinPersonLookupInfoRemoteSearchQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinPersonLookupInfoRemoteSearchQuery(val *JellyfinPersonLookupInfoRemoteSearchQuery) *NullableJellyfinPersonLookupInfoRemoteSearchQuery {
	return &NullableJellyfinPersonLookupInfoRemoteSearchQuery{value: val, isSet: true}
}

func (v NullableJellyfinPersonLookupInfoRemoteSearchQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinPersonLookupInfoRemoteSearchQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
