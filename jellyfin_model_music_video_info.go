...
// checks if the JellyfinMusicVideoInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinMusicVideoInfo{}

// JellyfinMusicVideoInfo struct for JellyfinMusicVideoInfo
type JellyfinMusicVideoInfo struct {
...
func (o *JellyfinMusicVideoInfo) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *JellyfinMusicVideoInfo) SetOriginalTitleNil() {
...
func (o *JellyfinMusicVideoInfo) SetPathNil() {
	o.Path.Set(nil)
}
...
func (o *JellyfinMusicVideoInfo) SetMetadataLanguageNil() {
...
func (o *JellyfinMusicVideoInfo) SetMetadataCountryCodeNil() {
...
func (o *JellyfinMusicVideoInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *JellyfinMusicVideoInfo) SetIndexNumberNil() {
...
func (o *JellyfinMusicVideoInfo) SetParentIndexNumberNil() {
...
func (o *JellyfinMusicVideoInfo) SetPremiereDateNil() {
...
func (o JellyfinMusicVideoInfo) MarshalJSON() ([]byte, error) {
...
func (o JellyfinMusicVideoInfo) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinMusicVideoInfo struct {
	value *JellyfinMusicVideoInfo
	isSet bool
}

func (v NullableJellyfinMusicVideoInfo) Get() *JellyfinMusicVideoInfo {
	return v.value
}

func (v *NullableJellyfinMusicVideoInfo) Set(val *JellyfinMusicVideoInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinMusicVideoInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinMusicVideoInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinMusicVideoInfo(val *JellyfinMusicVideoInfo) *NullableJellyfinMusicVideoInfo {
	return &NullableJellyfinMusicVideoInfo{value: val, isSet: true}
}

func (v NullableJellyfinMusicVideoInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinMusicVideoInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
