...
// checks if the JellyfinBookInfoRemoteSearchQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinBookInfoRemoteSearchQuery{}

// JellyfinBookInfoRemoteSearchQuery struct for JellyfinBookInfoRemoteSearchQuery
type JellyfinBookInfoRemoteSearchQuery struct {
	SearchInfo NullableJellyfinBookInfo `json:"SearchInfo,omitempty"`
...
func NewJellyfinBookInfoRemoteSearchQuery() *JellyfinBookInfoRemoteSearchQuery {
	this := JellyfinBookInfoRemoteSearchQuery{}
	return &this
}
...
func (o *JellyfinBookInfoRemoteSearchQuery) GetSearchInfo() JellyfinBookInfo {
	if o == nil || IsNil(o.SearchInfo.Get()) {
		var ret JellyfinBookInfo
		return ret
	}
...
func (o *JellyfinBookInfoRemoteSearchQuery) GetSearchInfoOk() (*JellyfinBookInfo, bool) {
	if o == nil {
		return nil, false
	}
...
// SetSearchInfo gets a reference to the given NullableJellyfinBookInfo and assigns it to the SearchInfo field.
func (o *JellyfinBookInfoRemoteSearchQuery) SetSearchInfo(v JellyfinBookInfo) {
	o.SearchInfo.Set(&v)
}
// SetSearchInfoNil sets the value for SearchInfo to be an explicit nil
func (o *JellyfinBookInfoRemoteSearchQuery) SetSearchInfoNil() {
...
func (o *JellyfinBookInfoRemoteSearchQuery) SetSearchProviderNameNil() {
...
func (o JellyfinBookInfoRemoteSearchQuery) MarshalJSON() ([]byte, error) {
...
func (o JellyfinBookInfoRemoteSearchQuery) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinBookInfoRemoteSearchQuery struct {
	value *JellyfinBookInfoRemoteSearchQuery
	isSet bool
}

func (v NullableJellyfinBookInfoRemoteSearchQuery) Get() *JellyfinBookInfoRemoteSearchQuery {
	return v.value
}

func (v *NullableJellyfinBookInfoRemoteSearchQuery) Set(val *JellyfinBookInfoRemoteSearchQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinBookInfoRemoteSearchQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinBookInfoRemoteSearchQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinBookInfoRemoteSearchQuery(val *JellyfinBookInfoRemoteSearchQuery) *NullableJellyfinBookInfoRemoteSearchQuery {
	return &NullableJellyfinBookInfoRemoteSearchQuery{value: val, isSet: true}
}

func (v NullableJellyfinBookInfoRemoteSearchQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinBookInfoRemoteSearchQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
