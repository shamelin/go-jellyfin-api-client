...
// checks if the JellyfinPlaybackInfoDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinPlaybackInfoDto{}

// JellyfinPlaybackInfoDto Plabyback info dto.
type JellyfinPlaybackInfoDto struct {
...
func (o *JellyfinPlaybackInfoDto) SetUserIdNil() {
	o.UserId.Set(nil)
}
...
func (o *JellyfinPlaybackInfoDto) SetMaxStreamingBitrateNil() {
...
func (o *JellyfinPlaybackInfoDto) SetStartTimeTicksNil() {
...
func (o *JellyfinPlaybackInfoDto) SetAudioStreamIndexNil() {
...
func (o *JellyfinPlaybackInfoDto) SetSubtitleStreamIndexNil() {
...
func (o *JellyfinPlaybackInfoDto) SetMaxAudioChannelsNil() {
...
func (o *JellyfinPlaybackInfoDto) SetMediaSourceIdNil() {
...
func (o *JellyfinPlaybackInfoDto) SetLiveStreamIdNil() {
...
func (o *JellyfinPlaybackInfoDto) GetDeviceProfile() JellyfinDeviceProfile {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinPlaybackInfoDto) GetDeviceProfileOk() (*JellyfinDeviceProfile, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *JellyfinPlaybackInfoDto) SetDeviceProfile(v JellyfinDeviceProfile) {
	o.DeviceProfile.Set(&v)
}
// SetDeviceProfileNil sets the value for DeviceProfile to be an explicit nil
func (o *JellyfinPlaybackInfoDto) SetDeviceProfileNil() {
...
func (o *JellyfinPlaybackInfoDto) SetEnableDirectPlayNil() {
...
func (o *JellyfinPlaybackInfoDto) SetEnableDirectStreamNil() {
...
func (o *JellyfinPlaybackInfoDto) SetEnableTranscodingNil() {
...
func (o *JellyfinPlaybackInfoDto) SetAllowVideoStreamCopyNil() {
...
func (o *JellyfinPlaybackInfoDto) SetAllowAudioStreamCopyNil() {
...
func (o *JellyfinPlaybackInfoDto) SetAutoOpenLiveStreamNil() {
...
func (o *JellyfinPlaybackInfoDto) SetAlwaysBurnInSubtitleWhenTranscodingNil() {
...
func (o JellyfinPlaybackInfoDto) MarshalJSON() ([]byte, error) {
...
func (o JellyfinPlaybackInfoDto) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinPlaybackInfoDto struct {
	value *JellyfinPlaybackInfoDto
	isSet bool
}

func (v NullableJellyfinPlaybackInfoDto) Get() *JellyfinPlaybackInfoDto {
	return v.value
}

func (v *NullableJellyfinPlaybackInfoDto) Set(val *JellyfinPlaybackInfoDto) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinPlaybackInfoDto) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinPlaybackInfoDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinPlaybackInfoDto(val *JellyfinPlaybackInfoDto) *NullableJellyfinPlaybackInfoDto {
	return &NullableJellyfinPlaybackInfoDto{value: val, isSet: true}
}

func (v NullableJellyfinPlaybackInfoDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinPlaybackInfoDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
