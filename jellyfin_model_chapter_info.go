...
// checks if the JellyfinChapterInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinChapterInfo{}

// JellyfinChapterInfo Class ChapterInfo.
type JellyfinChapterInfo struct {
...
func (o *JellyfinChapterInfo) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *JellyfinChapterInfo) SetImagePathNil() {
	o.ImagePath.Set(nil)
}
...
func (o *JellyfinChapterInfo) SetImageTagNil() {
	o.ImageTag.Set(nil)
}
...
func (o JellyfinChapterInfo) MarshalJSON() ([]byte, error) {
...
func (o JellyfinChapterInfo) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinChapterInfo struct {
	value *JellyfinChapterInfo
	isSet bool
}

func (v NullableJellyfinChapterInfo) Get() *JellyfinChapterInfo {
	return v.value
}

func (v *NullableJellyfinChapterInfo) Set(val *JellyfinChapterInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinChapterInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinChapterInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinChapterInfo(val *JellyfinChapterInfo) *NullableJellyfinChapterInfo {
	return &NullableJellyfinChapterInfo{value: val, isSet: true}
}

func (v NullableJellyfinChapterInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinChapterInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
