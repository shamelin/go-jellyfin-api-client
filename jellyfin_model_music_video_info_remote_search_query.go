...
// checks if the JellyfinMusicVideoInfoRemoteSearchQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinMusicVideoInfoRemoteSearchQuery{}

// JellyfinMusicVideoInfoRemoteSearchQuery struct for JellyfinMusicVideoInfoRemoteSearchQuery
type JellyfinMusicVideoInfoRemoteSearchQuery struct {
	SearchInfo NullableJellyfinMusicVideoInfo `json:"SearchInfo,omitempty"`
...
func NewJellyfinMusicVideoInfoRemoteSearchQuery() *JellyfinMusicVideoInfoRemoteSearchQuery {
	this := JellyfinMusicVideoInfoRemoteSearchQuery{}
	return &this
}
...
func (o *JellyfinMusicVideoInfoRemoteSearchQuery) GetSearchInfo() JellyfinMusicVideoInfo {
	if o == nil || IsNil(o.SearchInfo.Get()) {
		var ret JellyfinMusicVideoInfo
		return ret
	}
...
func (o *JellyfinMusicVideoInfoRemoteSearchQuery) GetSearchInfoOk() (*JellyfinMusicVideoInfo, bool) {
	if o == nil {
		return nil, false
	}
...
// SetSearchInfo gets a reference to the given NullableJellyfinMusicVideoInfo and assigns it to the SearchInfo field.
func (o *JellyfinMusicVideoInfoRemoteSearchQuery) SetSearchInfo(v JellyfinMusicVideoInfo) {
	o.SearchInfo.Set(&v)
}
// SetSearchInfoNil sets the value for SearchInfo to be an explicit nil
func (o *JellyfinMusicVideoInfoRemoteSearchQuery) SetSearchInfoNil() {
...
func (o *JellyfinMusicVideoInfoRemoteSearchQuery) SetSearchProviderNameNil() {
...
func (o JellyfinMusicVideoInfoRemoteSearchQuery) MarshalJSON() ([]byte, error) {
...
func (o JellyfinMusicVideoInfoRemoteSearchQuery) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinMusicVideoInfoRemoteSearchQuery struct {
	value *JellyfinMusicVideoInfoRemoteSearchQuery
	isSet bool
}

func (v NullableJellyfinMusicVideoInfoRemoteSearchQuery) Get() *JellyfinMusicVideoInfoRemoteSearchQuery {
	return v.value
}

func (v *NullableJellyfinMusicVideoInfoRemoteSearchQuery) Set(val *JellyfinMusicVideoInfoRemoteSearchQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinMusicVideoInfoRemoteSearchQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinMusicVideoInfoRemoteSearchQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinMusicVideoInfoRemoteSearchQuery(val *JellyfinMusicVideoInfoRemoteSearchQuery) *NullableJellyfinMusicVideoInfoRemoteSearchQuery {
	return &NullableJellyfinMusicVideoInfoRemoteSearchQuery{value: val, isSet: true}
}

func (v NullableJellyfinMusicVideoInfoRemoteSearchQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinMusicVideoInfoRemoteSearchQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
