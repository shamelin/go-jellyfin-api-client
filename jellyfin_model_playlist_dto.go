...
// checks if the JellyfinPlaylistDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinPlaylistDto{}

// JellyfinPlaylistDto DTO for playlists.
type JellyfinPlaylistDto struct {
	...
	Shares []JellyfinPlaylistUserPermissions `json:"Shares,omitempty"`
...
func (o *JellyfinPlaylistDto) GetShares() []JellyfinPlaylistUserPermissions {
...
// and a boolean to check if the value has been set.
func (o *JellyfinPlaylistDto) GetSharesOk() ([]JellyfinPlaylistUserPermissions, bool) {
	if o == nil || IsNil(o.Shares) {
		return nil, false
	}
...
// SetShares gets a reference to the given []JellyfinPlaylistUserPermissions and assigns it to the Shares field.
func (o *JellyfinPlaylistDto) SetShares(v []JellyfinPlaylistUserPermissions) {
	o.Shares = v
}
...
func (o JellyfinPlaylistDto) MarshalJSON() ([]byte, error) {
...
func (o JellyfinPlaylistDto) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinPlaylistDto struct {
	value *JellyfinPlaylistDto
	isSet bool
}

func (v NullableJellyfinPlaylistDto) Get() *JellyfinPlaylistDto {
	return v.value
}

func (v *NullableJellyfinPlaylistDto) Set(val *JellyfinPlaylistDto) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinPlaylistDto) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinPlaylistDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinPlaylistDto(val *JellyfinPlaylistDto) *NullableJellyfinPlaylistDto {
	return &NullableJellyfinPlaylistDto{value: val, isSet: true}
}

func (v NullableJellyfinPlaylistDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinPlaylistDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
