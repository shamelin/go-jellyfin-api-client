...
// APIClient manages communication with the Jellyfin API API v10.10.2
...
type APIClient struct {
	...
	ClientLogAPI *ClientLogAPIService
	...
	LyricsAPI *LyricsAPIService

	MediaInfoAPI *MediaInfoAPIService

	MediaSegmentsAPI *MediaSegmentsAPIService
	...
	TrickplayAPI *TrickplayAPIService
