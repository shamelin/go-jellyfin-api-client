...
// checks if the JellyfinRemoteImageInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinRemoteImageInfo{}

// JellyfinRemoteImageInfo Class RemoteImageInfo.
type JellyfinRemoteImageInfo struct {
	...
	RatingType *JellyfinRatingType `json:"RatingType,omitempty"`
}
...
func (o *JellyfinRemoteImageInfo) SetProviderNameNil() {
...
func (o *JellyfinRemoteImageInfo) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o *JellyfinRemoteImageInfo) SetThumbnailUrlNil() {
...
func (o *JellyfinRemoteImageInfo) SetHeightNil() {
	o.Height.Set(nil)
}
...
func (o *JellyfinRemoteImageInfo) SetWidthNil() {
	o.Width.Set(nil)
}
...
func (o *JellyfinRemoteImageInfo) SetCommunityRatingNil() {
...
func (o *JellyfinRemoteImageInfo) SetVoteCountNil() {
	o.VoteCount.Set(nil)
}
...
func (o *JellyfinRemoteImageInfo) SetLanguageNil() {
	o.Language.Set(nil)
}
...
func (o *JellyfinRemoteImageInfo) GetType() JellyfinImageType {
...
// and a boolean to check if the value has been set.
func (o *JellyfinRemoteImageInfo) GetTypeOk() (*JellyfinImageType, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *JellyfinRemoteImageInfo) SetType(v JellyfinImageType) {
	o.Type = &v
}

// GetRatingType returns the RatingType field value if set, zero value otherwise.
func (o *JellyfinRemoteImageInfo) GetRatingType() JellyfinRatingType {
	if o == nil || IsNil(o.RatingType) {
		var ret JellyfinRatingType
		return ret
	}
	return *o.RatingType
}
...
// and a boolean to check if the value has been set.
func (o *JellyfinRemoteImageInfo) GetRatingTypeOk() (*JellyfinRatingType, bool) {
	if o == nil || IsNil(o.RatingType) {
		return nil, false
	}
...
// SetRatingType gets a reference to the given JellyfinRatingType and assigns it to the RatingType field.
func (o *JellyfinRemoteImageInfo) SetRatingType(v JellyfinRatingType) {
	o.RatingType = &v
}

func (o JellyfinRemoteImageInfo) MarshalJSON() ([]byte, error) {
...
func (o JellyfinRemoteImageInfo) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinRemoteImageInfo struct {
	value *JellyfinRemoteImageInfo
	isSet bool
}

func (v NullableJellyfinRemoteImageInfo) Get() *JellyfinRemoteImageInfo {
	return v.value
}

func (v *NullableJellyfinRemoteImageInfo) Set(val *JellyfinRemoteImageInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinRemoteImageInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinRemoteImageInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinRemoteImageInfo(val *JellyfinRemoteImageInfo) *NullableJellyfinRemoteImageInfo {
	return &NullableJellyfinRemoteImageInfo{value: val, isSet: true}
}

func (v NullableJellyfinRemoteImageInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinRemoteImageInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
