...
// checks if the JellyfinRemoteSearchResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinRemoteSearchResult{}

// JellyfinRemoteSearchResult struct for JellyfinRemoteSearchResult
type JellyfinRemoteSearchResult struct {
	...
	AlbumArtist NullableJellyfinRemoteSearchResult `json:"AlbumArtist,omitempty"`
	Artists []JellyfinRemoteSearchResult `json:"Artists,omitempty"`
}
...
func NewJellyfinRemoteSearchResult() *JellyfinRemoteSearchResult {
	this := JellyfinRemoteSearchResult{}
	return &this
}
...
func (o *JellyfinRemoteSearchResult) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *JellyfinRemoteSearchResult) SetProductionYearNil() {
...
func (o *JellyfinRemoteSearchResult) SetIndexNumberNil() {
...
func (o *JellyfinRemoteSearchResult) SetIndexNumberEndNil() {
...
func (o *JellyfinRemoteSearchResult) SetParentIndexNumberNil() {
...
func (o *JellyfinRemoteSearchResult) SetPremiereDateNil() {
...
func (o *JellyfinRemoteSearchResult) SetImageUrlNil() {
	o.ImageUrl.Set(nil)
}
...
func (o *JellyfinRemoteSearchResult) SetSearchProviderNameNil() {
...
func (o *JellyfinRemoteSearchResult) SetOverviewNil() {
	o.Overview.Set(nil)
}
...
func (o *JellyfinRemoteSearchResult) GetAlbumArtist() JellyfinRemoteSearchResult {
	if o == nil || IsNil(o.AlbumArtist.Get()) {
		var ret JellyfinRemoteSearchResult
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinRemoteSearchResult) GetAlbumArtistOk() (*JellyfinRemoteSearchResult, bool) {
	if o == nil {
		return nil, false
	}
...
// SetAlbumArtist gets a reference to the given NullableJellyfinRemoteSearchResult and assigns it to the AlbumArtist field.
func (o *JellyfinRemoteSearchResult) SetAlbumArtist(v JellyfinRemoteSearchResult) {
	o.AlbumArtist.Set(&v)
}
// SetAlbumArtistNil sets the value for AlbumArtist to be an explicit nil
func (o *JellyfinRemoteSearchResult) SetAlbumArtistNil() {
...
func (o *JellyfinRemoteSearchResult) GetArtists() []JellyfinRemoteSearchResult {
	if o == nil {
		var ret []JellyfinRemoteSearchResult
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinRemoteSearchResult) GetArtistsOk() ([]JellyfinRemoteSearchResult, bool) {
...
// SetArtists gets a reference to the given []JellyfinRemoteSearchResult and assigns it to the Artists field.
func (o *JellyfinRemoteSearchResult) SetArtists(v []JellyfinRemoteSearchResult) {
	o.Artists = v
}

func (o JellyfinRemoteSearchResult) MarshalJSON() ([]byte, error) {
...
func (o JellyfinRemoteSearchResult) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinRemoteSearchResult struct {
	value *JellyfinRemoteSearchResult
	isSet bool
}

func (v NullableJellyfinRemoteSearchResult) Get() *JellyfinRemoteSearchResult {
	return v.value
}

func (v *NullableJellyfinRemoteSearchResult) Set(val *JellyfinRemoteSearchResult) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinRemoteSearchResult) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinRemoteSearchResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinRemoteSearchResult(val *JellyfinRemoteSearchResult) *NullableJellyfinRemoteSearchResult {
	return &NullableJellyfinRemoteSearchResult{value: val, isSet: true}
}

func (v NullableJellyfinRemoteSearchResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinRemoteSearchResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
