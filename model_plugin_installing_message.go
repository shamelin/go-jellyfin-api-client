...
// checks if the PluginInstallingMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluginInstallingMessage{}
...
type NullablePluginInstallingMessage struct {
	value *PluginInstallingMessage
	isSet bool
}

func (v NullablePluginInstallingMessage) Get() *PluginInstallingMessage {
	return v.value
}

func (v *NullablePluginInstallingMessage) Set(val *PluginInstallingMessage) {
	v.value = val
	v.isSet = true
}

func (v NullablePluginInstallingMessage) IsSet() bool {
	return v.isSet
}

func (v *NullablePluginInstallingMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePluginInstallingMessage(val *PluginInstallingMessage) *NullablePluginInstallingMessage {
	return &NullablePluginInstallingMessage{value: val, isSet: true}
}
