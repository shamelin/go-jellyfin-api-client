...
// checks if the JellyfinWakeOnLanInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinWakeOnLanInfo{}

// JellyfinWakeOnLanInfo Provides the MAC address and port for wake-on-LAN functionality.
type JellyfinWakeOnLanInfo struct {
...
func (o *JellyfinWakeOnLanInfo) SetMacAddressNil() {
...
func (o JellyfinWakeOnLanInfo) MarshalJSON() ([]byte, error) {
...
func (o JellyfinWakeOnLanInfo) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinWakeOnLanInfo struct {
	value *JellyfinWakeOnLanInfo
	isSet bool
}

func (v NullableJellyfinWakeOnLanInfo) Get() *JellyfinWakeOnLanInfo {
	return v.value
}

func (v *NullableJellyfinWakeOnLanInfo) Set(val *JellyfinWakeOnLanInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinWakeOnLanInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinWakeOnLanInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinWakeOnLanInfo(val *JellyfinWakeOnLanInfo) *NullableJellyfinWakeOnLanInfo {
	return &NullableJellyfinWakeOnLanInfo{value: val, isSet: true}
}

func (v NullableJellyfinWakeOnLanInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinWakeOnLanInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
