...
// checks if the ThemeMediaResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThemeMediaResult{}
...
type NullableThemeMediaResult struct {
	value *ThemeMediaResult
	isSet bool
}

func (v NullableThemeMediaResult) Get() *ThemeMediaResult {
	return v.value
}

func (v *NullableThemeMediaResult) Set(val *ThemeMediaResult) {
	v.value = val
	v.isSet = true
}
...
func NewNullableThemeMediaResult(val *ThemeMediaResult) *NullableThemeMediaResult {
	return &NullableThemeMediaResult{value: val, isSet: true}
}
