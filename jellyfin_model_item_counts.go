...
// checks if the JellyfinItemCounts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinItemCounts{}

// JellyfinItemCounts Class LibrarySummary.
...
func (o *JellyfinItemCounts) SetMovieCount(v int32) {
	o.MovieCount = &v
}
...
func (o JellyfinItemCounts) MarshalJSON() ([]byte, error) {
...
func (o JellyfinItemCounts) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinItemCounts struct {
	value *JellyfinItemCounts
	isSet bool
}

func (v NullableJellyfinItemCounts) Get() *JellyfinItemCounts {
	return v.value
}

func (v *NullableJellyfinItemCounts) Set(val *JellyfinItemCounts) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinItemCounts) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinItemCounts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinItemCounts(val *JellyfinItemCounts) *NullableJellyfinItemCounts {
	return &NullableJellyfinItemCounts{value: val, isSet: true}
}

func (v NullableJellyfinItemCounts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinItemCounts) UnmarshalJSON(src []byte) error {
	v.isSet = true
