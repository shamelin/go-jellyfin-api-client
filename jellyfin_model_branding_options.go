...
// checks if the JellyfinBrandingOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinBrandingOptions{}

// JellyfinBrandingOptions The branding options.
type JellyfinBrandingOptions struct {
...
func (o *JellyfinBrandingOptions) SetLoginDisclaimerNil() {
...
func (o *JellyfinBrandingOptions) SetCustomCssNil() {
	o.CustomCss.Set(nil)
}
...
func (o JellyfinBrandingOptions) MarshalJSON() ([]byte, error) {
...
func (o JellyfinBrandingOptions) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinBrandingOptions struct {
	value *JellyfinBrandingOptions
	isSet bool
}

func (v NullableJellyfinBrandingOptions) Get() *JellyfinBrandingOptions {
	return v.value
}

func (v *NullableJellyfinBrandingOptions) Set(val *JellyfinBrandingOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinBrandingOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinBrandingOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinBrandingOptions(val *JellyfinBrandingOptions) *NullableJellyfinBrandingOptions {
	return &NullableJellyfinBrandingOptions{value: val, isSet: true}
}

func (v NullableJellyfinBrandingOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinBrandingOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
