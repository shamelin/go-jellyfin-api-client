...
// checks if the JellyfinBaseItemDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinBaseItemDto{}

// JellyfinBaseItemDto This is strictly used as a data transfer object from the api layer.  This holds information about a BaseItem in a format that is convenient for the client.
type JellyfinBaseItemDto struct {
	...
	ExtraType NullableJellyfinExtraType `json:"ExtraType,omitempty"`
	...
	ExternalUrls []JellyfinExternalUrl `json:"ExternalUrls,omitempty"`
	...
	PlayAccess NullableJellyfinPlayAccess `json:"PlayAccess,omitempty"`
	...
	RemoteTrailers []JellyfinMediaUrl `json:"RemoteTrailers,omitempty"`
	...
	// The base item kind.
	Type *JellyfinBaseItemKind `json:"Type,omitempty"`
	// Gets or sets the people.
	People []JellyfinBaseItemPerson `json:"People,omitempty"`
	// Gets or sets the studios.
	Studios []JellyfinNameGuidPair `json:"Studios,omitempty"`
	GenreItems []JellyfinNameGuidPair `json:"GenreItems,omitempty"`
	...
	UserData NullableJellyfinUserItemDataDto `json:"UserData,omitempty"`
	...
	AirDays []JellyfinDayOfWeek `json:"AirDays,omitempty"`
	...
	ArtistItems []JellyfinNameGuidPair `json:"ArtistItems,omitempty"`
	// Gets or sets the album.
	Album NullableString `json:"Album,omitempty"`
	// Gets or sets the type of the collection.
	CollectionType NullableJellyfinCollectionType `json:"CollectionType,omitempty"`
	...
	AlbumArtists []JellyfinNameGuidPair `json:"AlbumArtists,omitempty"`
	...
	ImageBlurHashes NullableJellyfinBaseItemDtoImageBlurHashes `json:"ImageBlurHashes,omitempty"`
	...
	Chapters []JellyfinChapterInfo `json:"Chapters,omitempty"`
	// Gets or sets the trickplay manifest.
	Trickplay map[string]map[string]JellyfinTrickplayInfo `json:"Trickplay,omitempty"`
	// Gets or sets the type of the location.
	LocationType NullableJellyfinLocationType `json:"LocationType,omitempty"`
	// Gets or sets the type of the iso.
	IsoType NullableJellyfinIsoType `json:"IsoType,omitempty"`
	// Media types.
	MediaType *JellyfinMediaType `json:"MediaType,omitempty"`
	// Gets or sets the end date.
	EndDate NullableTime `json:"EndDate,omitempty"`
	// Gets or sets the locked fields.
	LockedFields []JellyfinMetadataField `json:"LockedFields,omitempty"`
	...
	ImageOrientation NullableJellyfinImageOrientation `json:"ImageOrientation,omitempty"`
	...
	ChannelType NullableJellyfinChannelType `json:"ChannelType,omitempty"`
	// Gets or sets the audio.
	Audio NullableJellyfinProgramAudio `json:"Audio,omitempty"`
	...
	CurrentProgram NullableJellyfinBaseItemDto `json:"CurrentProgram,omitempty"`
}
...
func (o *JellyfinBaseItemDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetOriginalTitleNil() {
...
func (o *JellyfinBaseItemDto) SetServerIdNil() {
	o.ServerId.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetEtagNil() {
	o.Etag.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetSourceTypeNil() {
...
func (o *JellyfinBaseItemDto) SetPlaylistItemIdNil() {
...
func (o *JellyfinBaseItemDto) SetDateCreatedNil() {
...
func (o *JellyfinBaseItemDto) SetDateLastMediaAddedNil() {
...
func (o *JellyfinBaseItemDto) GetExtraType() JellyfinExtraType {
	if o == nil || IsNil(o.ExtraType.Get()) {
		var ret JellyfinExtraType
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetExtraTypeOk() (*JellyfinExtraType, bool) {
	if o == nil {
		return nil, false
	}
...
// SetExtraType gets a reference to the given NullableJellyfinExtraType and assigns it to the ExtraType field.
func (o *JellyfinBaseItemDto) SetExtraType(v JellyfinExtraType) {
	o.ExtraType.Set(&v)
}
// SetExtraTypeNil sets the value for ExtraType to be an explicit nil
func (o *JellyfinBaseItemDto) SetExtraTypeNil() {
	o.ExtraType.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetAirsBeforeSeasonNumberNil() {
...
func (o *JellyfinBaseItemDto) SetAirsAfterSeasonNumberNil() {
...
func (o *JellyfinBaseItemDto) SetAirsBeforeEpisodeNumberNil() {
...
func (o *JellyfinBaseItemDto) SetCanDeleteNil() {
	o.CanDelete.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetCanDownloadNil() {
...
func (o *JellyfinBaseItemDto) SetHasLyricsNil() {
	o.HasLyrics.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetHasSubtitlesNil() {
...
func (o *JellyfinBaseItemDto) SetPreferredMetadataLanguageNil() {
...
func (o *JellyfinBaseItemDto) SetPreferredMetadataCountryCodeNil() {
...
func (o *JellyfinBaseItemDto) SetContainerNil() {
	o.Container.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetSortNameNil() {
	o.SortName.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetForcedSortNameNil() {
...
func (o *JellyfinBaseItemDto) GetVideo3DFormat() JellyfinVideo3DFormat {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetVideo3DFormatOk() (*JellyfinVideo3DFormat, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *JellyfinBaseItemDto) SetVideo3DFormat(v JellyfinVideo3DFormat) {
	o.Video3DFormat.Set(&v)
}
// SetVideo3DFormatNil sets the value for Video3DFormat to be an explicit nil
func (o *JellyfinBaseItemDto) SetVideo3DFormatNil() {
...
func (o *JellyfinBaseItemDto) SetPremiereDateNil() {
...
func (o *JellyfinBaseItemDto) GetExternalUrls() []JellyfinExternalUrl {
	if o == nil {
		var ret []JellyfinExternalUrl
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetExternalUrlsOk() ([]JellyfinExternalUrl, bool) {
...
// SetExternalUrls gets a reference to the given []JellyfinExternalUrl and assigns it to the ExternalUrls field.
func (o *JellyfinBaseItemDto) SetExternalUrls(v []JellyfinExternalUrl) {
	o.ExternalUrls = v
}

// GetMediaSources returns the MediaSources field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *JellyfinBaseItemDto) GetMediaSources() []JellyfinMediaSourceInfo {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetMediaSourcesOk() ([]JellyfinMediaSourceInfo, bool) {
...
func (o *JellyfinBaseItemDto) SetMediaSources(v []JellyfinMediaSourceInfo) {
	o.MediaSources = v
}
...
func (o *JellyfinBaseItemDto) SetCriticRatingNil() {
...
func (o *JellyfinBaseItemDto) SetPathNil() {
	o.Path.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetEnableMediaSourceDisplayNil() {
...
func (o *JellyfinBaseItemDto) SetOfficialRatingNil() {
...
func (o *JellyfinBaseItemDto) SetCustomRatingNil() {
...
func (o *JellyfinBaseItemDto) SetChannelIdNil() {
	o.ChannelId.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetChannelNameNil() {
...
func (o *JellyfinBaseItemDto) SetOverviewNil() {
	o.Overview.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetCommunityRatingNil() {
...
func (o *JellyfinBaseItemDto) SetCumulativeRunTimeTicksNil() {
...
func (o *JellyfinBaseItemDto) SetRunTimeTicksNil() {
...
func (o *JellyfinBaseItemDto) GetPlayAccess() JellyfinPlayAccess {
	if o == nil || IsNil(o.PlayAccess.Get()) {
		var ret JellyfinPlayAccess
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetPlayAccessOk() (*JellyfinPlayAccess, bool) {
	if o == nil {
		return nil, false
	}
...
// SetPlayAccess gets a reference to the given NullableJellyfinPlayAccess and assigns it to the PlayAccess field.
func (o *JellyfinBaseItemDto) SetPlayAccess(v JellyfinPlayAccess) {
	o.PlayAccess.Set(&v)
}
// SetPlayAccessNil sets the value for PlayAccess to be an explicit nil
func (o *JellyfinBaseItemDto) SetPlayAccessNil() {
...
func (o *JellyfinBaseItemDto) SetAspectRatioNil() {
...
func (o *JellyfinBaseItemDto) SetProductionYearNil() {
...
func (o *JellyfinBaseItemDto) SetIsPlaceHolderNil() {
...
func (o *JellyfinBaseItemDto) SetNumberNil() {
	o.Number.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetChannelNumberNil() {
...
func (o *JellyfinBaseItemDto) SetIndexNumberNil() {
...
func (o *JellyfinBaseItemDto) SetIndexNumberEndNil() {
...
func (o *JellyfinBaseItemDto) SetParentIndexNumberNil() {
...
func (o *JellyfinBaseItemDto) GetRemoteTrailers() []JellyfinMediaUrl {
	if o == nil {
		var ret []JellyfinMediaUrl
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetRemoteTrailersOk() ([]JellyfinMediaUrl, bool) {
...
// SetRemoteTrailers gets a reference to the given []JellyfinMediaUrl and assigns it to the RemoteTrailers field.
func (o *JellyfinBaseItemDto) SetRemoteTrailers(v []JellyfinMediaUrl) {
	o.RemoteTrailers = v
}
...
func (o *JellyfinBaseItemDto) SetIsHDNil() {
	o.IsHD.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetIsFolderNil() {
	o.IsFolder.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetParentIdNil() {
	o.ParentId.Set(nil)
}
...
func (o *JellyfinBaseItemDto) GetType() JellyfinBaseItemKind {
	if o == nil || IsNil(o.Type) {
		var ret JellyfinBaseItemKind
		return ret
	}
	return *o.Type
}
...
// and a boolean to check if the value has been set.
func (o *JellyfinBaseItemDto) GetTypeOk() (*JellyfinBaseItemKind, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
// SetType gets a reference to the given JellyfinBaseItemKind and assigns it to the Type field.
func (o *JellyfinBaseItemDto) SetType(v JellyfinBaseItemKind) {
	o.Type = &v
}

// GetPeople returns the People field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *JellyfinBaseItemDto) GetPeople() []JellyfinBaseItemPerson {
	if o == nil {
		var ret []JellyfinBaseItemPerson
		return ret
	}
	return o.People
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetPeopleOk() ([]JellyfinBaseItemPerson, bool) {
...
// SetPeople gets a reference to the given []JellyfinBaseItemPerson and assigns it to the People field.
func (o *JellyfinBaseItemDto) SetPeople(v []JellyfinBaseItemPerson) {
	o.People = v
}

// GetStudios returns the Studios field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *JellyfinBaseItemDto) GetStudios() []JellyfinNameGuidPair {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetStudiosOk() ([]JellyfinNameGuidPair, bool) {
...
// SetStudios gets a reference to the given []JellyfinNameGuidPair and assigns it to the Studios field.
func (o *JellyfinBaseItemDto) SetStudios(v []JellyfinNameGuidPair) {
	o.Studios = v
}

// GetGenreItems returns the GenreItems field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *JellyfinBaseItemDto) GetGenreItems() []JellyfinNameGuidPair {
	if o == nil {
		var ret []JellyfinNameGuidPair
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetGenreItemsOk() ([]JellyfinNameGuidPair, bool) {
...
// SetGenreItems gets a reference to the given []JellyfinNameGuidPair and assigns it to the GenreItems field.
func (o *JellyfinBaseItemDto) SetGenreItems(v []JellyfinNameGuidPair) {
	o.GenreItems = v
}
...
func (o *JellyfinBaseItemDto) SetParentLogoItemIdNil() {
...
func (o *JellyfinBaseItemDto) SetParentBackdropItemIdNil() {
...
func (o *JellyfinBaseItemDto) SetLocalTrailerCountNil() {
...
func (o *JellyfinBaseItemDto) GetUserData() JellyfinUserItemDataDto {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetUserDataOk() (*JellyfinUserItemDataDto, bool) {
	if o == nil {
		return nil, false
	}
...
// SetUserData gets a reference to the given NullableJellyfinUserItemDataDto and assigns it to the UserData field.
func (o *JellyfinBaseItemDto) SetUserData(v JellyfinUserItemDataDto) {
	o.UserData.Set(&v)
}
// SetUserDataNil sets the value for UserData to be an explicit nil
func (o *JellyfinBaseItemDto) SetUserDataNil() {
	o.UserData.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetRecursiveItemCountNil() {
...
func (o *JellyfinBaseItemDto) SetChildCountNil() {
...
func (o *JellyfinBaseItemDto) SetSeriesNameNil() {
...
func (o *JellyfinBaseItemDto) SetSeriesIdNil() {
	o.SeriesId.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetSeasonIdNil() {
	o.SeasonId.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetSpecialFeatureCountNil() {
...
func (o *JellyfinBaseItemDto) SetDisplayPreferencesIdNil() {
...
func (o *JellyfinBaseItemDto) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetAirTimeNil() {
	o.AirTime.Set(nil)
}
...
func (o *JellyfinBaseItemDto) GetAirDays() []JellyfinDayOfWeek {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetAirDaysOk() ([]JellyfinDayOfWeek, bool) {
...
// SetAirDays gets a reference to the given []JellyfinDayOfWeek and assigns it to the AirDays field.
func (o *JellyfinBaseItemDto) SetAirDays(v []JellyfinDayOfWeek) {
	o.AirDays = v
}
...
func (o *JellyfinBaseItemDto) SetPrimaryImageAspectRatioNil() {
...
func (o *JellyfinBaseItemDto) GetArtistItems() []JellyfinNameGuidPair {
	if o == nil {
		var ret []JellyfinNameGuidPair
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetArtistItemsOk() ([]JellyfinNameGuidPair, bool) {
...
// SetArtistItems gets a reference to the given []JellyfinNameGuidPair and assigns it to the ArtistItems field.
func (o *JellyfinBaseItemDto) SetArtistItems(v []JellyfinNameGuidPair) {
	o.ArtistItems = v
}
...
func (o *JellyfinBaseItemDto) SetAlbumNil() {
	o.Album.Set(nil)
}
...
func (o *JellyfinBaseItemDto) GetCollectionType() JellyfinCollectionType {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetCollectionTypeOk() (*JellyfinCollectionType, bool) {
	if o == nil {
		return nil, false
	}
...
// SetCollectionType gets a reference to the given NullableJellyfinCollectionType and assigns it to the CollectionType field.
func (o *JellyfinBaseItemDto) SetCollectionType(v JellyfinCollectionType) {
	o.CollectionType.Set(&v)
}
// SetCollectionTypeNil sets the value for CollectionType to be an explicit nil
func (o *JellyfinBaseItemDto) SetCollectionTypeNil() {
...
func (o *JellyfinBaseItemDto) SetDisplayOrderNil() {
...
func (o *JellyfinBaseItemDto) SetAlbumIdNil() {
	o.AlbumId.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetAlbumPrimaryImageTagNil() {
...
func (o *JellyfinBaseItemDto) SetSeriesPrimaryImageTagNil() {
...
func (o *JellyfinBaseItemDto) SetAlbumArtistNil() {
...
func (o *JellyfinBaseItemDto) GetAlbumArtists() []JellyfinNameGuidPair {
	if o == nil {
		var ret []JellyfinNameGuidPair
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetAlbumArtistsOk() ([]JellyfinNameGuidPair, bool) {
...
// SetAlbumArtists gets a reference to the given []JellyfinNameGuidPair and assigns it to the AlbumArtists field.
func (o *JellyfinBaseItemDto) SetAlbumArtists(v []JellyfinNameGuidPair) {
	o.AlbumArtists = v
}
...
func (o *JellyfinBaseItemDto) SetSeasonNameNil() {
...
func (o *JellyfinBaseItemDto) GetMediaStreams() []JellyfinMediaStream {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetMediaStreamsOk() ([]JellyfinMediaStream, bool) {
...
func (o *JellyfinBaseItemDto) SetMediaStreams(v []JellyfinMediaStream) {
	o.MediaStreams = v
}

// GetVideoType returns the VideoType field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *JellyfinBaseItemDto) GetVideoType() JellyfinVideoType {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetVideoTypeOk() (*JellyfinVideoType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *JellyfinBaseItemDto) SetVideoType(v JellyfinVideoType) {
	o.VideoType.Set(&v)
}
// SetVideoTypeNil sets the value for VideoType to be an explicit nil
func (o *JellyfinBaseItemDto) SetVideoTypeNil() {
	o.VideoType.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetPartCountNil() {
	o.PartCount.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetMediaSourceCountNil() {
...
func (o *JellyfinBaseItemDto) SetParentLogoImageTagNil() {
...
func (o *JellyfinBaseItemDto) SetParentArtItemIdNil() {
...
func (o *JellyfinBaseItemDto) SetParentArtImageTagNil() {
...
func (o *JellyfinBaseItemDto) SetSeriesThumbImageTagNil() {
...
func (o *JellyfinBaseItemDto) GetImageBlurHashes() JellyfinBaseItemDtoImageBlurHashes {
	if o == nil || IsNil(o.ImageBlurHashes.Get()) {
		var ret JellyfinBaseItemDtoImageBlurHashes
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetImageBlurHashesOk() (*JellyfinBaseItemDtoImageBlurHashes, bool) {
	if o == nil {
		return nil, false
	}
...
// SetImageBlurHashes gets a reference to the given NullableJellyfinBaseItemDtoImageBlurHashes and assigns it to the ImageBlurHashes field.
func (o *JellyfinBaseItemDto) SetImageBlurHashes(v JellyfinBaseItemDtoImageBlurHashes) {
	o.ImageBlurHashes.Set(&v)
}
// SetImageBlurHashesNil sets the value for ImageBlurHashes to be an explicit nil
func (o *JellyfinBaseItemDto) SetImageBlurHashesNil() {
...
func (o *JellyfinBaseItemDto) SetSeriesStudioNil() {
...
func (o *JellyfinBaseItemDto) SetParentThumbItemIdNil() {
...
func (o *JellyfinBaseItemDto) SetParentThumbImageTagNil() {
...
func (o *JellyfinBaseItemDto) SetParentPrimaryImageItemIdNil() {
...
func (o *JellyfinBaseItemDto) SetParentPrimaryImageTagNil() {
...
func (o *JellyfinBaseItemDto) GetChapters() []JellyfinChapterInfo {
	if o == nil {
		var ret []JellyfinChapterInfo
		return ret
	}
	return o.Chapters
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetChaptersOk() ([]JellyfinChapterInfo, bool) {
...
// SetChapters gets a reference to the given []JellyfinChapterInfo and assigns it to the Chapters field.
func (o *JellyfinBaseItemDto) SetChapters(v []JellyfinChapterInfo) {
	o.Chapters = v
}

// GetTrickplay returns the Trickplay field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *JellyfinBaseItemDto) GetTrickplay() map[string]map[string]JellyfinTrickplayInfo {
	if o == nil {
		var ret map[string]map[string]JellyfinTrickplayInfo
		return ret
	}
	return o.Trickplay
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetTrickplayOk() (*map[string]map[string]JellyfinTrickplayInfo, bool) {
...
// SetTrickplay gets a reference to the given map[string]map[string]JellyfinTrickplayInfo and assigns it to the Trickplay field.
func (o *JellyfinBaseItemDto) SetTrickplay(v map[string]map[string]JellyfinTrickplayInfo) {
	o.Trickplay = v
}

// GetLocationType returns the LocationType field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *JellyfinBaseItemDto) GetLocationType() JellyfinLocationType {
	if o == nil || IsNil(o.LocationType.Get()) {
		var ret JellyfinLocationType
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetLocationTypeOk() (*JellyfinLocationType, bool) {
	if o == nil {
		return nil, false
	}
...
// SetLocationType gets a reference to the given NullableJellyfinLocationType and assigns it to the LocationType field.
func (o *JellyfinBaseItemDto) SetLocationType(v JellyfinLocationType) {
	o.LocationType.Set(&v)
}
// SetLocationTypeNil sets the value for LocationType to be an explicit nil
func (o *JellyfinBaseItemDto) SetLocationTypeNil() {
...
func (o *JellyfinBaseItemDto) GetIsoType() JellyfinIsoType {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetIsoTypeOk() (*JellyfinIsoType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *JellyfinBaseItemDto) SetIsoType(v JellyfinIsoType) {
	o.IsoType.Set(&v)
}
// SetIsoTypeNil sets the value for IsoType to be an explicit nil
func (o *JellyfinBaseItemDto) SetIsoTypeNil() {
	o.IsoType.Set(nil)
}
...
func (o *JellyfinBaseItemDto) GetMediaType() JellyfinMediaType {
...
// and a boolean to check if the value has been set.
func (o *JellyfinBaseItemDto) GetMediaTypeOk() (*JellyfinMediaType, bool) {
	if o == nil || IsNil(o.MediaType) {
		return nil, false
	}
...
// SetMediaType gets a reference to the given JellyfinMediaType and assigns it to the MediaType field.
func (o *JellyfinBaseItemDto) SetMediaType(v JellyfinMediaType) {
	o.MediaType = &v
}
...
func (o *JellyfinBaseItemDto) SetEndDateNil() {
	o.EndDate.Set(nil)
}
...
func (o *JellyfinBaseItemDto) GetLockedFields() []JellyfinMetadataField {
	if o == nil {
		var ret []JellyfinMetadataField
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetLockedFieldsOk() ([]JellyfinMetadataField, bool) {
...
// SetLockedFields gets a reference to the given []JellyfinMetadataField and assigns it to the LockedFields field.
func (o *JellyfinBaseItemDto) SetLockedFields(v []JellyfinMetadataField) {
	o.LockedFields = v
}
...
func (o *JellyfinBaseItemDto) SetTrailerCountNil() {
...
func (o *JellyfinBaseItemDto) SetMovieCountNil() {
...
func (o *JellyfinBaseItemDto) SetSeriesCountNil() {
...
func (o *JellyfinBaseItemDto) SetProgramCountNil() {
...
func (o *JellyfinBaseItemDto) SetEpisodeCountNil() {
...
func (o *JellyfinBaseItemDto) SetSongCountNil() {
	o.SongCount.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetAlbumCountNil() {
...
func (o *JellyfinBaseItemDto) SetArtistCountNil() {
...
func (o *JellyfinBaseItemDto) SetMusicVideoCountNil() {
...
func (o *JellyfinBaseItemDto) SetLockDataNil() {
	o.LockData.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetWidthNil() {
	o.Width.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetHeightNil() {
	o.Height.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetCameraMakeNil() {
...
func (o *JellyfinBaseItemDto) SetCameraModelNil() {
...
func (o *JellyfinBaseItemDto) SetSoftwareNil() {
	o.Software.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetExposureTimeNil() {
...
func (o *JellyfinBaseItemDto) SetFocalLengthNil() {
...
func (o *JellyfinBaseItemDto) GetImageOrientation() JellyfinImageOrientation {
	if o == nil || IsNil(o.ImageOrientation.Get()) {
		var ret JellyfinImageOrientation
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetImageOrientationOk() (*JellyfinImageOrientation, bool) {
	if o == nil {
		return nil, false
	}
...
// SetImageOrientation gets a reference to the given NullableJellyfinImageOrientation and assigns it to the ImageOrientation field.
func (o *JellyfinBaseItemDto) SetImageOrientation(v JellyfinImageOrientation) {
	o.ImageOrientation.Set(&v)
}
// SetImageOrientationNil sets the value for ImageOrientation to be an explicit nil
func (o *JellyfinBaseItemDto) SetImageOrientationNil() {
...
func (o *JellyfinBaseItemDto) SetApertureNil() {
	o.Aperture.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetShutterSpeedNil() {
...
func (o *JellyfinBaseItemDto) SetLatitudeNil() {
	o.Latitude.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetLongitudeNil() {
	o.Longitude.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetAltitudeNil() {
	o.Altitude.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetIsoSpeedRatingNil() {
...
func (o *JellyfinBaseItemDto) SetSeriesTimerIdNil() {
...
func (o *JellyfinBaseItemDto) SetProgramIdNil() {
	o.ProgramId.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetChannelPrimaryImageTagNil() {
...
func (o *JellyfinBaseItemDto) SetStartDateNil() {
	o.StartDate.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetCompletionPercentageNil() {
...
func (o *JellyfinBaseItemDto) SetIsRepeatNil() {
	o.IsRepeat.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetEpisodeTitleNil() {
...
func (o *JellyfinBaseItemDto) GetChannelType() JellyfinChannelType {
	if o == nil || IsNil(o.ChannelType.Get()) {
		var ret JellyfinChannelType
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetChannelTypeOk() (*JellyfinChannelType, bool) {
	if o == nil {
		return nil, false
	}
...
// SetChannelType gets a reference to the given NullableJellyfinChannelType and assigns it to the ChannelType field.
func (o *JellyfinBaseItemDto) SetChannelType(v JellyfinChannelType) {
	o.ChannelType.Set(&v)
}
// SetChannelTypeNil sets the value for ChannelType to be an explicit nil
func (o *JellyfinBaseItemDto) SetChannelTypeNil() {
...
func (o *JellyfinBaseItemDto) GetAudio() JellyfinProgramAudio {
	if o == nil || IsNil(o.Audio.Get()) {
		var ret JellyfinProgramAudio
		return ret
	}
	return *o.Audio.Get()
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetAudioOk() (*JellyfinProgramAudio, bool) {
	if o == nil {
		return nil, false
	}
...
// SetAudio gets a reference to the given NullableJellyfinProgramAudio and assigns it to the Audio field.
func (o *JellyfinBaseItemDto) SetAudio(v JellyfinProgramAudio) {
	o.Audio.Set(&v)
}
// SetAudioNil sets the value for Audio to be an explicit nil
func (o *JellyfinBaseItemDto) SetAudioNil() {
	o.Audio.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetIsMovieNil() {
	o.IsMovie.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetIsSportsNil() {
	o.IsSports.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetIsSeriesNil() {
	o.IsSeries.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetIsLiveNil() {
	o.IsLive.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetIsNewsNil() {
	o.IsNews.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetIsKidsNil() {
	o.IsKids.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetIsPremiereNil() {
...
func (o *JellyfinBaseItemDto) SetTimerIdNil() {
	o.TimerId.Set(nil)
}
...
func (o *JellyfinBaseItemDto) SetNormalizationGainNil() {
...
func (o *JellyfinBaseItemDto) GetCurrentProgram() JellyfinBaseItemDto {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBaseItemDto) GetCurrentProgramOk() (*JellyfinBaseItemDto, bool) {
	if o == nil {
		return nil, false
	}
...
// SetCurrentProgram gets a reference to the given NullableJellyfinBaseItemDto and assigns it to the CurrentProgram field.
func (o *JellyfinBaseItemDto) SetCurrentProgram(v JellyfinBaseItemDto) {
	o.CurrentProgram.Set(&v)
}
// SetCurrentProgramNil sets the value for CurrentProgram to be an explicit nil
func (o *JellyfinBaseItemDto) SetCurrentProgramNil() {
...
func (o JellyfinBaseItemDto) MarshalJSON() ([]byte, error) {
...
func (o JellyfinBaseItemDto) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinBaseItemDto struct {
	value *JellyfinBaseItemDto
	isSet bool
}

func (v NullableJellyfinBaseItemDto) Get() *JellyfinBaseItemDto {
	return v.value
}

func (v *NullableJellyfinBaseItemDto) Set(val *JellyfinBaseItemDto) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinBaseItemDto) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinBaseItemDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinBaseItemDto(val *JellyfinBaseItemDto) *NullableJellyfinBaseItemDto {
	return &NullableJellyfinBaseItemDto{value: val, isSet: true}
}

func (v NullableJellyfinBaseItemDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinBaseItemDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
