...
// checks if the JellyfinBoxSetInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinBoxSetInfo{}

// JellyfinBoxSetInfo struct for JellyfinBoxSetInfo
type JellyfinBoxSetInfo struct {
...
func (o *JellyfinBoxSetInfo) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *JellyfinBoxSetInfo) SetOriginalTitleNil() {
...
func (o *JellyfinBoxSetInfo) SetPathNil() {
	o.Path.Set(nil)
}
...
func (o *JellyfinBoxSetInfo) SetMetadataLanguageNil() {
...
func (o *JellyfinBoxSetInfo) SetMetadataCountryCodeNil() {
...
func (o *JellyfinBoxSetInfo) GetProviderIds() map[string]string {
	if o == nil {
...
func (o *JellyfinBoxSetInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *JellyfinBoxSetInfo) SetIndexNumberNil() {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinBoxSetInfo) GetParentIndexNumberOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *JellyfinBoxSetInfo) SetParentIndexNumberNil() {
...
func (o *JellyfinBoxSetInfo) SetPremiereDateNil() {
...
func (o JellyfinBoxSetInfo) MarshalJSON() ([]byte, error) {
...
func (o JellyfinBoxSetInfo) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinBoxSetInfo struct {
	value *JellyfinBoxSetInfo
	isSet bool
}

func (v NullableJellyfinBoxSetInfo) Get() *JellyfinBoxSetInfo {
	return v.value
}

func (v *NullableJellyfinBoxSetInfo) Set(val *JellyfinBoxSetInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinBoxSetInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinBoxSetInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinBoxSetInfo(val *JellyfinBoxSetInfo) *NullableJellyfinBoxSetInfo {
	return &NullableJellyfinBoxSetInfo{value: val, isSet: true}
}

func (v NullableJellyfinBoxSetInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinBoxSetInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
