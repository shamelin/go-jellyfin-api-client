...
// checks if the PlaybackStartInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlaybackStartInfo{}
...
type NullablePlaybackStartInfo struct {
	value *PlaybackStartInfo
	isSet bool
}

func (v NullablePlaybackStartInfo) Get() *PlaybackStartInfo {
	return v.value
}

func (v *NullablePlaybackStartInfo) Set(val *PlaybackStartInfo) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePlaybackStartInfo(val *PlaybackStartInfo) *NullablePlaybackStartInfo {
	return &NullablePlaybackStartInfo{value: val, isSet: true}
}
