...
// checks if the JellyfinTimerInfoDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinTimerInfoDto{}

// JellyfinTimerInfoDto struct for JellyfinTimerInfoDto
type JellyfinTimerInfoDto struct {
	...
	Status *JellyfinRecordingStatus `json:"Status,omitempty"`
	...
	ProgramInfo NullableJellyfinBaseItemDto `json:"ProgramInfo,omitempty"`
}
...
func (o *JellyfinTimerInfoDto) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *JellyfinTimerInfoDto) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *JellyfinTimerInfoDto) SetServerIdNil() {
	o.ServerId.Set(nil)
}
...
func (o *JellyfinTimerInfoDto) SetExternalIdNil() {
...
func (o *JellyfinTimerInfoDto) SetExternalChannelIdNil() {
...
func (o *JellyfinTimerInfoDto) SetChannelNameNil() {
...
func (o *JellyfinTimerInfoDto) SetChannelPrimaryImageTagNil() {
...
func (o *JellyfinTimerInfoDto) SetProgramIdNil() {
	o.ProgramId.Set(nil)
}
...
func (o *JellyfinTimerInfoDto) SetExternalProgramIdNil() {
...
func (o *JellyfinTimerInfoDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *JellyfinTimerInfoDto) SetOverviewNil() {
	o.Overview.Set(nil)
}
...
func (o *JellyfinTimerInfoDto) SetServiceNameNil() {
...
func (o *JellyfinTimerInfoDto) SetParentBackdropItemIdNil() {
...
func (o *JellyfinTimerInfoDto) GetKeepUntil() JellyfinKeepUntil {
...
// and a boolean to check if the value has been set.
func (o *JellyfinTimerInfoDto) GetKeepUntilOk() (*JellyfinKeepUntil, bool) {
	if o == nil || IsNil(o.KeepUntil) {
		return nil, false
	}
...
func (o *JellyfinTimerInfoDto) SetKeepUntil(v JellyfinKeepUntil) {
	o.KeepUntil = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *JellyfinTimerInfoDto) GetStatus() JellyfinRecordingStatus {
	if o == nil || IsNil(o.Status) {
		var ret JellyfinRecordingStatus
		return ret
	}
	return *o.Status
}
...
// and a boolean to check if the value has been set.
func (o *JellyfinTimerInfoDto) GetStatusOk() (*JellyfinRecordingStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
// SetStatus gets a reference to the given JellyfinRecordingStatus and assigns it to the Status field.
func (o *JellyfinTimerInfoDto) SetStatus(v JellyfinRecordingStatus) {
	o.Status = &v
}
...
func (o *JellyfinTimerInfoDto) SetSeriesTimerIdNil() {
...
func (o *JellyfinTimerInfoDto) SetExternalSeriesTimerIdNil() {
...
func (o *JellyfinTimerInfoDto) SetRunTimeTicksNil() {
...
func (o *JellyfinTimerInfoDto) GetProgramInfo() JellyfinBaseItemDto {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinTimerInfoDto) GetProgramInfoOk() (*JellyfinBaseItemDto, bool) {
	if o == nil {
		return nil, false
	}
...
// SetProgramInfo gets a reference to the given NullableJellyfinBaseItemDto and assigns it to the ProgramInfo field.
func (o *JellyfinTimerInfoDto) SetProgramInfo(v JellyfinBaseItemDto) {
	o.ProgramInfo.Set(&v)
}
// SetProgramInfoNil sets the value for ProgramInfo to be an explicit nil
func (o *JellyfinTimerInfoDto) SetProgramInfoNil() {
...
func (o JellyfinTimerInfoDto) MarshalJSON() ([]byte, error) {
...
func (o JellyfinTimerInfoDto) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinTimerInfoDto struct {
	value *JellyfinTimerInfoDto
	isSet bool
}

func (v NullableJellyfinTimerInfoDto) Get() *JellyfinTimerInfoDto {
	return v.value
}

func (v *NullableJellyfinTimerInfoDto) Set(val *JellyfinTimerInfoDto) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinTimerInfoDto) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinTimerInfoDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinTimerInfoDto(val *JellyfinTimerInfoDto) *NullableJellyfinTimerInfoDto {
	return &NullableJellyfinTimerInfoDto{value: val, isSet: true}
}

func (v NullableJellyfinTimerInfoDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinTimerInfoDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
