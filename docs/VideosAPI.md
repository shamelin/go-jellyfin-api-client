...
> JellyfinJellyfinBaseItemDtoQueryResult GetAdditionalPart(ctx, itemId).UserId(userId).Execute()
...
func main() {
	...
	// response from `GetAdditionalPart`: JellyfinJellyfinBaseItemDtoQueryResult
