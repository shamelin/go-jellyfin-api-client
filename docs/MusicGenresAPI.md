...
> JellyfinJellyfinBaseItemDto GetMusicGenre(ctx, genreName).UserId(userId).Execute()
...
func main() {
	...
	// response from `GetMusicGenre`: JellyfinJellyfinBaseItemDto
...
func main() {
	...
	// response from `GetMusicGenres`: JellyfinJellyfinBaseItemDtoQueryResult
