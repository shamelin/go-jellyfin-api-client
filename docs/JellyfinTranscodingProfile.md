...
**TranscodeSeekInfo** | Pointer to [**JellyfinJellyfinTranscodeSeekInfo**](JellyfinTranscodeSeekInfo.md) | Gets or sets the transcoding seek info mode. | [optional] [default to AUTO]
...
**Context** | Pointer to [**JellyfinJellyfinEncodingContext**](JellyfinEncodingContext.md) | Gets or sets the encoding context. | [optional] [default to STREAMING]
