...
// checks if the JellyfinTranscodingInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinTranscodingInfo{}

// JellyfinTranscodingInfo Class holding information on a runnning transcode.
type JellyfinTranscodingInfo struct {
	...
	HardwareAccelerationType NullableJellyfinHardwareAccelerationType `json:"HardwareAccelerationType,omitempty"`
	// Gets or sets the transcode reasons.
	TranscodeReasons []JellyfinTranscodeReason `json:"TranscodeReasons,omitempty"`
}
...
func (o *JellyfinTranscodingInfo) SetAudioCodecNil() {
...
func (o *JellyfinTranscodingInfo) SetVideoCodecNil() {
...
func (o *JellyfinTranscodingInfo) SetContainerNil() {
	o.Container.Set(nil)
}
...
func (o *JellyfinTranscodingInfo) SetBitrateNil() {
	o.Bitrate.Set(nil)
}
...
func (o *JellyfinTranscodingInfo) SetFramerateNil() {
	o.Framerate.Set(nil)
}
...
func (o *JellyfinTranscodingInfo) SetCompletionPercentageNil() {
...
func (o *JellyfinTranscodingInfo) SetWidthNil() {
	o.Width.Set(nil)
}
...
func (o *JellyfinTranscodingInfo) SetHeightNil() {
	o.Height.Set(nil)
}
...
func (o *JellyfinTranscodingInfo) SetAudioChannelsNil() {
...
func (o *JellyfinTranscodingInfo) GetHardwareAccelerationType() JellyfinHardwareAccelerationType {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinTranscodingInfo) GetHardwareAccelerationTypeOk() (*JellyfinHardwareAccelerationType, bool) {
	if o == nil {
		return nil, false
	}
...
// SetHardwareAccelerationType gets a reference to the given NullableJellyfinHardwareAccelerationType and assigns it to the HardwareAccelerationType field.
func (o *JellyfinTranscodingInfo) SetHardwareAccelerationType(v JellyfinHardwareAccelerationType) {
...
func (o *JellyfinTranscodingInfo) SetHardwareAccelerationTypeNil() {
...
func (o *JellyfinTranscodingInfo) GetTranscodeReasons() []JellyfinTranscodeReason {
	if o == nil || IsNil(o.TranscodeReasons) {
		var ret []JellyfinTranscodeReason
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *JellyfinTranscodingInfo) GetTranscodeReasonsOk() ([]JellyfinTranscodeReason, bool) {
	if o == nil || IsNil(o.TranscodeReasons) {
		return nil, false
	}
...
// SetTranscodeReasons gets a reference to the given []JellyfinTranscodeReason and assigns it to the TranscodeReasons field.
func (o *JellyfinTranscodingInfo) SetTranscodeReasons(v []JellyfinTranscodeReason) {
	o.TranscodeReasons = v
}

func (o JellyfinTranscodingInfo) MarshalJSON() ([]byte, error) {
...
func (o JellyfinTranscodingInfo) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinTranscodingInfo struct {
	value *JellyfinTranscodingInfo
	isSet bool
}

func (v NullableJellyfinTranscodingInfo) Get() *JellyfinTranscodingInfo {
	return v.value
}

func (v *NullableJellyfinTranscodingInfo) Set(val *JellyfinTranscodingInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinTranscodingInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinTranscodingInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinTranscodingInfo(val *JellyfinTranscodingInfo) *NullableJellyfinTranscodingInfo {
	return &NullableJellyfinTranscodingInfo{value: val, isSet: true}
}

func (v NullableJellyfinTranscodingInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinTranscodingInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
