...
// checks if the JellyfinSeriesInfoRemoteSearchQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinSeriesInfoRemoteSearchQuery{}

// JellyfinSeriesInfoRemoteSearchQuery struct for JellyfinSeriesInfoRemoteSearchQuery
type JellyfinSeriesInfoRemoteSearchQuery struct {
	SearchInfo NullableJellyfinSeriesInfo `json:"SearchInfo,omitempty"`
...
func NewJellyfinSeriesInfoRemoteSearchQuery() *JellyfinSeriesInfoRemoteSearchQuery {
	this := JellyfinSeriesInfoRemoteSearchQuery{}
	return &this
}
...
func (o *JellyfinSeriesInfoRemoteSearchQuery) GetSearchInfo() JellyfinSeriesInfo {
	if o == nil || IsNil(o.SearchInfo.Get()) {
		var ret JellyfinSeriesInfo
		return ret
	}
...
func (o *JellyfinSeriesInfoRemoteSearchQuery) GetSearchInfoOk() (*JellyfinSeriesInfo, bool) {
	if o == nil {
		return nil, false
	}
...
// SetSearchInfo gets a reference to the given NullableJellyfinSeriesInfo and assigns it to the SearchInfo field.
func (o *JellyfinSeriesInfoRemoteSearchQuery) SetSearchInfo(v JellyfinSeriesInfo) {
	o.SearchInfo.Set(&v)
}
// SetSearchInfoNil sets the value for SearchInfo to be an explicit nil
func (o *JellyfinSeriesInfoRemoteSearchQuery) SetSearchInfoNil() {
...
func (o *JellyfinSeriesInfoRemoteSearchQuery) SetSearchProviderNameNil() {
...
func (o JellyfinSeriesInfoRemoteSearchQuery) MarshalJSON() ([]byte, error) {
...
func (o JellyfinSeriesInfoRemoteSearchQuery) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinSeriesInfoRemoteSearchQuery struct {
	value *JellyfinSeriesInfoRemoteSearchQuery
	isSet bool
}

func (v NullableJellyfinSeriesInfoRemoteSearchQuery) Get() *JellyfinSeriesInfoRemoteSearchQuery {
	return v.value
}

func (v *NullableJellyfinSeriesInfoRemoteSearchQuery) Set(val *JellyfinSeriesInfoRemoteSearchQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinSeriesInfoRemoteSearchQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinSeriesInfoRemoteSearchQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinSeriesInfoRemoteSearchQuery(val *JellyfinSeriesInfoRemoteSearchQuery) *NullableJellyfinSeriesInfoRemoteSearchQuery {
	return &NullableJellyfinSeriesInfoRemoteSearchQuery{value: val, isSet: true}
}

func (v NullableJellyfinSeriesInfoRemoteSearchQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinSeriesInfoRemoteSearchQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
