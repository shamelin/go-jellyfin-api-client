...
// checks if the JellyfinLibraryOptionInfoDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinLibraryOptionInfoDto{}

// JellyfinLibraryOptionInfoDto Library option info dto.
type JellyfinLibraryOptionInfoDto struct {
	// Gets or sets name.
...
func NewJellyfinLibraryOptionInfoDto() *JellyfinLibraryOptionInfoDto {
	this := JellyfinLibraryOptionInfoDto{}
	return &this
}
...
func (o *JellyfinLibraryOptionInfoDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o JellyfinLibraryOptionInfoDto) MarshalJSON() ([]byte, error) {
...
func (o JellyfinLibraryOptionInfoDto) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinLibraryOptionInfoDto struct {
	value *JellyfinLibraryOptionInfoDto
	isSet bool
}

func (v NullableJellyfinLibraryOptionInfoDto) Get() *JellyfinLibraryOptionInfoDto {
	return v.value
}

func (v *NullableJellyfinLibraryOptionInfoDto) Set(val *JellyfinLibraryOptionInfoDto) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinLibraryOptionInfoDto) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinLibraryOptionInfoDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinLibraryOptionInfoDto(val *JellyfinLibraryOptionInfoDto) *NullableJellyfinLibraryOptionInfoDto {
	return &NullableJellyfinLibraryOptionInfoDto{value: val, isSet: true}
}

func (v NullableJellyfinLibraryOptionInfoDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinLibraryOptionInfoDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
