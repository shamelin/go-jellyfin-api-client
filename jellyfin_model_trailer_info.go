...
// checks if the JellyfinTrailerInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JellyfinTrailerInfo{}

// JellyfinTrailerInfo struct for JellyfinTrailerInfo
type JellyfinTrailerInfo struct {
...
func (o *JellyfinTrailerInfo) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *JellyfinTrailerInfo) SetOriginalTitleNil() {
...
func (o *JellyfinTrailerInfo) SetPathNil() {
	o.Path.Set(nil)
}
...
func (o *JellyfinTrailerInfo) SetMetadataLanguageNil() {
...
func (o *JellyfinTrailerInfo) SetMetadataCountryCodeNil() {
...
func (o *JellyfinTrailerInfo) GetProviderIds() map[string]string {
	if o == nil {
...
func (o *JellyfinTrailerInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *JellyfinTrailerInfo) SetIndexNumberNil() {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *JellyfinTrailerInfo) GetParentIndexNumberOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *JellyfinTrailerInfo) SetParentIndexNumberNil() {
...
func (o *JellyfinTrailerInfo) SetPremiereDateNil() {
...
func (o JellyfinTrailerInfo) MarshalJSON() ([]byte, error) {
...
func (o JellyfinTrailerInfo) ToMap() (map[string]interface{}, error) {
...
type NullableJellyfinTrailerInfo struct {
	value *JellyfinTrailerInfo
	isSet bool
}

func (v NullableJellyfinTrailerInfo) Get() *JellyfinTrailerInfo {
	return v.value
}

func (v *NullableJellyfinTrailerInfo) Set(val *JellyfinTrailerInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableJellyfinTrailerInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableJellyfinTrailerInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJellyfinTrailerInfo(val *JellyfinTrailerInfo) *NullableJellyfinTrailerInfo {
	return &NullableJellyfinTrailerInfo{value: val, isSet: true}
}

func (v NullableJellyfinTrailerInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJellyfinTrailerInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
